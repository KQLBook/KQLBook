...
interface CloudflareEnv extends KqlSecretBindings {}

declare namespace Cloudflare {
	// eslint-disable-next-line @typescript-eslint/no-empty-object-type
	interface Env extends KqlSecretBindings {}
}

declare namespace NodeJS {
	interface ProcessEnv extends KqlSecretBindings {
